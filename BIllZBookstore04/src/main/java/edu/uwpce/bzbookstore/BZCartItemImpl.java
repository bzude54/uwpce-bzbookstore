...
public class BZCartItemImpl implements BZCartItem {
	
    private static final Logger logger = LoggerFactory.getLogger(BZCartItemImpl.class);
	...
	public BZCartItemImpl(BZBook book) {
		this.cartItemQty = 1;
